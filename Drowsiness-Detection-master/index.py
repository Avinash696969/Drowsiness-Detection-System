...
Button(root,text="Run using web cam",font=("times new roman",20),bg="#0D47A1",fg='white').grid(row=5,columnspan=5,sticky=W+E+N+S,padx=5,pady=5)
Button(root,text="Run using phone cam",font=("times new roman",20),bg="#0D47A1",fg='white').grid(row=7,columnspan=5,sticky=W+E+N+S,padx=5,pady=5)
